...
console.log(SCHOOL);
//SCHOOL = "OtherCollege";//
// when you tried to uncomment this it gives you an error due to the const //
...
console.log('2+"3" = ', "2"+3);
console.log('2+3 = ', "2"+3);
console.log("why do the first two concatenate ?");
console.log("because in JS it consider it as a string and perform string concatenation.");
...
console.log("The final array is: ", nums);
console.log("The final array's length is: ", nums.length);
